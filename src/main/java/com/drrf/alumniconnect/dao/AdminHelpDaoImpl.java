...
//                        .newMapper(AdminHelpRequests.class);
    ...
    public String updateAdminHelpStatus(AdminHelpRequestStatus adminHelpRequestStatus) {
        ...
        if (Status == "New") {
            String st = "Update DRF.TBL_ADMIN_HELP_REQUEST_STATUS SET STATUS=?,SET CREATE_TIMESTAMP=? WHERE STUDENT_ID=?";
            jdbcTemplate.queryForObject(Status,new Object[]{"InProgress",instant,id},new AdminHelpStatusRowMapper());
